...
#
"""
Various utility functions that did not fit anywhere else yet.

The factorize() and divisors_from_factors() (and related functions) are cribbed directly from:

     http://forums.xkcd.com/viewtopic.php?f=11&t=88300
